<!-- Footer -->
<div class="w-fit absolute bottom-0 my-4 mx-3">
  <a
    title="Github"
    aria-label="Github"
    href="https://github.com/arithefirst/dressing-room"
    rel="noreferrer"
    target="_blank"
  ...
  <a
    title="Made by April Hall"
    aria-label="Made by April Hall"
    href="https://www.arithefirst.com/"
    rel="noreferrer"
    target="_blank"
    class="px-2 btn-icon variant-filled-primary"
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
      ><g fill="none"
        ><path
